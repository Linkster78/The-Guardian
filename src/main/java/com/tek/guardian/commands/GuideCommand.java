...
public class GuideCommand extends Command {
	...
	private final List<String> GUIDES = Arrays.asList(
			...
			"How to setup custom voice channels?;*In this guide, we will see how to setup custom voice channels for users.*\n\n**1)** Create a category in your server, it will house all of the private voice channels.\n**2)** Set the voice channel category with this command `config vccategory <category-name>`.\n**3)** From this point on, if users want private voice channels, they can simply use `customvc <capacity>` and they will get a private voice channel.");
